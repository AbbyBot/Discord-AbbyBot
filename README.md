...
| `FOOTER_TEXT_ES`   | English text for all embed footers, example: `AbbyBot - Development`.           |
| `FOOTER_TEXT_ES`   | Spanish text for all embed footers, example: `AbbyBot - Desarrollo`.            |
